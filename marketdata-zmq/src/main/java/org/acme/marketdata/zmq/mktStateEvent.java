...
import org.acme.marketdata.zmq.Msgs.MktState;
...
public class mktStateEvent implements QuoteEvent {
	/**
     * 
     */
	...
	public String toString() {
		return mequity.toString() + " : State " +  mstate  ;
	}
