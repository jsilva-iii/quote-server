...
public class EquityMarketEvent {
    ...
    public EquityMarketEvent(String symbol, String xchg) {
    ...
    public synchronized TopOfBookEvent getTopOfBookEvent(double bid,
        ...
        BidEvent be = bidBuilder
                ...
                .withExchange(Exch)
                .withPrice(
                        new BigDecimal(bid).setScale(bid < 0.5 ? 3 : 2,
        ...
        AskEvent ae = askBuilder
                ...
                .withExchange(Exch)
                .withPrice(
                        new BigDecimal(ask).setScale(ask < 0.5 ? 3 : 2,
                                BigDecimal.ROUND_HALF_EVEN))
    ...
    public synchronized TopOfBookEvent getIndexQuoteEvent(Index index) {
        ...
        BidEvent be = bidBuilder
                ...
                .withExchange(Exch)
                .withPrice(
                        new BigDecimal(index.getBid()).setScale(2,
                                BigDecimal.ROUND_HALF_EVEN))
        ...
        AskEvent ae = askBuilder
                ...
                .withExchange(Exch)
                .withPrice(
                        new BigDecimal(index.getAsk()).setScale( 2,
                                BigDecimal.ROUND_HALF_EVEN))
                .withSize(new BigDecimal(0)).create();
        return tobBuilder.withMessageId(System.nanoTime()).withTimestamp(now)
                .withBid(be).withInstrument(equity).withAsk(ae).create();
