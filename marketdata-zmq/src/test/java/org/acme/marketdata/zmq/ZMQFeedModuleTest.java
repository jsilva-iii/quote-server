...
import org.acme.marketdata.zmq.ZMQFeedModule;
import org.acme.marketdata.zmq.ZMQFeedModuleFactory;
...
/**
 * Tests {@link ZMQFeedModule}.
 *
 * @author <a href="mailto:colin@marketcetera.com">Colin DuPlantis</a>
 * @version $Id: ZMQFeedModuleTest.java 16154 2012-07-14 16:34:05Z colin $
 * @since 1.0.0
 */
public class ZMQFeedModuleTest
    extends MarketDataModuleTestBase
{
                                         ...
                                         Object inData)
                {
                    try {
                        if(!dataRequested[0]) {
                            ...
                            createdFlows.add(moduleManager.createDataFlow(new DataRequest[] { new DataRequest(ZMQFeedModuleFactory.INSTANCE_URN,
    ...
    {
        return new ZMQFeedModuleFactory();
    }
    /* (non-Javadoc)
    ...
    {
        return ZMQFeedModuleFactory.INSTANCE_URN;
    }
    /* (non-Javadoc)
    ...
    {
        return ZMQFeedModuleFactory.IDENTIFIER;
    }
}
